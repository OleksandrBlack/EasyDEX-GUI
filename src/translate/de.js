export const LANG_DE = {
  ...
  'IMPORT_KEY': {
    ...
    'SAFE_RESCAN_WARNING_TIME': 'Das Neuscannen der gesamten Blockchain kann mehrere Stunden in Anspruch nehmen',
  ...
  'CLAIM_INTEREST': {
    ...
    'TIP': 'Tipp:',
    'NOTICE': 'Hinweis',
    'TIP_DESC': 'Versuchen Sie nicht weniger als weniger als 0,01 SAFE an Zinsen abzurufen. Die Transaktionsgebühr wäre gleich dem Zinsbetrag oder würde diesen übersteigen.',
  ...
  'ABOUT': {
    ...
    'ABOUT_SAFEWALLET': 'Über Safewallet',
    'SAFEWALLET_MODES': 'Safewallet Wallet ist eine Desktopanwendung, mit der Sie mehrere Wallets verschiedener Kryptowährungen verwalten können. Wenn Sie eine Wallet einrichten, können Sie diese für einen der folgenden Modi konfigurieren:',
    'NATIVE_MODE_DESC': 'Nicht für alle Währungen verfügbar. Wie \'Vollständiger Modus\', bietet jedoch erweiterte Funktionen.',
    'SAFEWALLET_CAPABILITIES': 'Safewallet enthält unter anderem die folgenden Funktionen:',
    'BARTER_DEX_DESC': 'Einfacher Umtausch von Kryptowährungen über einen Dienst, der ähnlich wie Shapeshift funktioniert.',
    'SAFEWALLET_NOTE': 'Hinweis: Safewallet Wallet befindet sich noch immer in der Entwicklung. Die Nutzung ist sicher, es sollten jedoch stets Backups gemacht werden. Wir empfehlen nicht, Safewallet als Haupt-Wallet für Ihre Kryptowährungen zu verwenden.',
    'TESTERS': 'Tester',
    'TESTERS_P1': 'Sie können uns dabei helfen, Safewallet zu testen. Laden Sie',
    ...
    'SAFEWALLET_DAPPS': 'Safewallet unterstützt außerdem folgende Desktop-Apps:',
  ...
  'API': {
    ...
    'SAFE_PASSIVE_ERROR': 'Bitte führen Sie safecoind manuell aus',
    'ERROR_SM': 'Fehler',
  ...
  'INDEX': {
    ...
    'SELECT_A_COIN': 'Coin auswählen, der zu Safewallet Wallet hinzugefügt werden soll',
    'WALLETS': 'Wallets',
    ...
    'NATIVE_MODE_DESC1': 'Dieser Modus ist NUR für SAFECOIN, PAX FIAT Chains, Asset-Chains und Geckochains verfügbar. Dieser Modus verwendet',
  ...
  'JUMBLR': {
    ...
    'NEED_NATIVE': 'Benötigt nativen Safecoin Modus',
    'TO_USE_JUMBLR': 'Um Jumblr verwenden zu können, müssen Sie Safecoin im nativen Modus aktivieren.',
    'IF_YOU_ALREADY_RUNNING': 'Wenn Safecoin bereits im Lite- oder Voll-Modus läuft, schließen Sie die Wallet und starten Sie Safecoin neu im Nativen Modus.',
    ...
    'START_SAFE': 'Starten Sie Safecoin entweder im Vollen Modus oder im Lite-Modus.',
    ...
    'RUN_SAFE': 'Starten Sie Safecoin im Nativen Modus',
    'LOGIN_SAFE': 'Melden Sie sich mit Ihrer Passphrase an',
    'GO_TO': 'Wechseln Sie in das Jumblr Menü',
    'FIND_DEPOSIT_ADDR': 'Hier finden Sie Ihre Einzahladresse für den Coin, dessen Guthaben Sie anonymisieren möchten. (Zunächst wird nur SAFE unterstützt. Unterstützung für BTC kommt in späteren Versionen)',
    'YOU_SEND_FUNDS': 'Senden Sie Ihre Mittel an die Einzahladresse.',
    'KEEP_WALLET_OPEN': 'Lassen Sie Ihre Wallet geöffnet',
    'IMPORTANT_FUNDS': '[WICHTIG] Die Mittel werden in Chargen von Größen zu 10 SAFE, 100 SAFE, 1.000 SAFE und 10.000 SAFE verarbeitet.',
    'LARGE_LOT': 'Die größeren Chargen werden zuerst, die kleineren im Anschluss verarbeitet.',
    'EG': 'Beispiel: Sie senden 1393 SAFE an Ihre SAFE Einzahladresse.<br>Zuerst werden 1.000 SAFE verarbeitet<br>dann 100 SAFE<br>dann 100 SAFE<br>dann 100 SAFE',
    '93_SAFE': '93 SAFE verbleiben auf Ihrer Einzahladresse.',
    'TO_CLEAR_THEM': 'Damit diese auch verarbeitet werden, müssen Sie weitere 7 SAFE an Ihre Einzahladresse senden.',
    'WHEN_IT_TOTALS': 'Sobald der Betrag 10/100/1000 SAFE erreicht, wird er verarbeitet und an Ihre SAFE Jumblr Adresse gesendet.',
    'JADDR': 'Jumblr Adressen',
    'BTC_DEPOSIT': 'BTC Einzahlung',
    'SHOW_HIDE': 'Anzeigen/Verbergen',
    'HIDDEN': 'Aus Sicherheitsgründen verborgen.',
    'SAFE_DEPOSIT': 'SAFE Einzahlung',
  ...
  'TOASTR': {
    ...
    'SAFECOIN_DATADIR_INVALID': 'Der Safecoin datadir Pfad ist ungültig.<br>Der Pfad muss ein absoluter Pfad zu einem vorhandenen Ordner sein und darf keine Leer- oder Sonderzeichen enthalten.',
    'SAFECOIN_DATADIR_NOT_DIR': 'Der Safecoin datadir Pfad ist kein Ordner.<br>Der Pfad muss ein absoluter Pfad zu einem vorhandenen Ordner sein und darf keine Leer- oder Sonderzeichen enthalten.',
    'INVALID_ADDRESS': 'Ungültige @template@ Adresse',
    'RESTART_SAFEWALLET_WITH_REINDEX_PARAM': 'Starten Sie Safewallet neu und führen Sie Safecoin mit dem Parameter -reindex aus',
    ...
    'SAFECOIN_ERR': 'Safecoind kann nicht gestartet werden',
    ...
    'SAFE_NATIVE_CON_ERROR': 'Verbindungsfehler. Wird die externe Wallet ausgeführt?',
  ...
  'SAFE_NATIVE': {
    ...
    'SELECT_ADDRESS_ALT': 'Transparente oder Private SAFE-Adresse wählen',
    'PRIVATE': 'Privat',
  ...
  'SETTINGS': {
    ...
    'SAFE_MAIN_SYNC_ONLY': 'SAFE main nur Sync',
