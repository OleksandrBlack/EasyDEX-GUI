...
export const LANG_EN = {
  ...
  'CLAIM_INTEREST': {
    ...
    'TIP': 'Tip',
    'NOTICE': 'Notice',
    'TIP_DESC': 'don\'t attempt to claim rewards smaller than 0.01 SAFE. A fee you have to pay for transaction will be more or equal to the interest amount.',
    'NATIVE_INTEREST_CHANGE_DESC': 'It\'s likely that reward is going to be credited as a separate transaction to a newely created SAFE address. This is how native implements interest claiming.',
  ...
  'JUMBLR': {
    ...
    'IF_YOU_ALREADY_RUNNING': 'If you are already running Safecoin in either Basilisk Mode or Full Mode, close the wallet and restart again to start Safecoin In Native Mode.',
    ...
    'START_SAFE': 'Start Safecoin in either Full Mode or Basilisk Mode.',
    ...
    'LOGIN_SAFE': 'Login with your passphrase',
  ...
  'TOASTR': {
    ...
    'SAFECOIN_DATADIR_INVALID': 'Safecoin datadir path is invalid.<br>It must be an absolute path to an existing folder that doesn\'t contain spaces and/or any special characters.',
    'SAFECOIN_DATADIR_NOT_DIR': 'Safecoin datadir path is not a directory.<br>It must be an absolute path to an existing folder that doesn\'t contain spaces and/or any special characters.',
  ...
  'LOGIN': {
    ...
    'SEED_ENCRYPT_KEY_CONFIRM': 'Seed encrypt confirm',
    ...
    'SEED_ENCRYPT_KEY': 'Seed encrypt key',
  ...
  'TOOLS': {
    ...
    'ADDRESSES': 'Addresses',
    'ADDRESS_MULTI': 'Enter SAFE pub addresses each address on a new line.',
