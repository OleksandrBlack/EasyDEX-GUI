      ...
      { this.renderBalance('transparent') !== -777 &&
        <div className="col-xs-12 flex">
          <div className={
            ...
            (this.props.ActiveCoin.mode === 'spv' && this.props.ActiveCoin.coin !== 'SAFE') ||
          ...
          <div className={ this.props.ActiveCoin.coin === 'SAFE' && Number(this.renderBalance('interest')) > 0 ? 'col-lg-3 col-xs-12' : 'hide' }>
            <div className="widget widget-shadow">
              <div className="widget-content">
                <div className="padding-20 padding-top-10">
                  <div className="clearfix cursor-default">
          ...
          <div className={
            this.props.ActiveCoin.coin === 'CHIPS' ||
            (this.props.ActiveCoin.coin !== 'SAFE' && this.props.ActiveCoin.mode === 'spv') ||
