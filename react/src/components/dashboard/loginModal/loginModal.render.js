                  ...
                  <div className="page-content vertical-align-middle">
                    <div className="brand">
                      <img
                        ...
                        alt="FairExchange Iguana" />
                    </div>
                    <div
                      id="section-login"
                      className={ this.state.activeLoginSection === 'login' ? 'show' : 'hide' }>
                      <h4
                        className="color-white"
                        id="login-welcome">{ translate('INDEX.WELCOME_LOGIN') }</h4>
                      <div className="login-form">
                        ...
                        <button
                          ...
                          disabled={ this.isLoginPassphraseEmpty() }>
